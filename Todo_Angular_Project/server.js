...
// configuration ===============================================================
mongoose.connect("mongodb+srv://tpoto:karting@se4frontend.kudyj4t.mongodb.net/?retryWrites=true&w=majority&appName=Se4Frontend", {
...
app.put('/api/todos/:todo_id', function(req, res) {
  console.log('Requête PUT reçue pour ID :', req.params.todo_id);
  ...
  Todo.findByIdAndUpdate(
      ...
      function(err, todo) {
          ...
          if (!todo) {
              console.warn('Todo non trouvé pour ID :', todoId);
